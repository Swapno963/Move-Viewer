...
const getDataById = (id) => {
  const movie = movieList.results.find(mv => mv.id == id);
  // console.log(movie,id);
  return movie ?? "Not found";
}
const editDataById = ({id,title}) => {
  console.log(title);
  const movieIndex = movieList.results.findIndex(mv => mv.id == parseInt(id));
  movieList.results[movieIndex].title = title.title
  return movieList.results[movieIndex];
}

const deleteDataById = (id) => {
  // console.log(title);
  const movieIndex = movieList.results.findIndex(mv => mv.id == parseInt(id));
  const deleteMove = movieList.results[movieIndex]
